...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <a href="view_patient_records.php" class="card-link ">Back to List</a>
    <a href="edit_patient_detail.php?id=<?php echo $result['Patient_Id'] ?>" class="card-link ">Edit</a>
    <a onclick="return confirm('Are you sure you want to delete this record?');" href="delete_patient.php?id=<?php echo $result['User_Id'] ?>" class="card-link" >Delete</a>
  </div>
</div>
<br/>
        <!-- <a href="view_patient_records.php" class="btn btn-info">Back to List</a>
