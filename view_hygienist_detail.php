<?php
    ...
    if(!isset($_GET['id'])){
        ...
        $id = $_GET['id'];
        $result = $crud->getHygienistDetails($id);
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <a href="view_hygienist_records.php" class="card-link ">Back to List</a>
    <a href="edit_hygienist_detail.php?id=<?php echo $result['Hygienist_Id'] ?>" class="card-link ">Edit</a>
    <a onclick="return confirm('Are you sure you want to delete this record?');" href="delete_hygienist.php?id=<?php echo $result['User_Id'] ?>" class="card-link" >Delete</a>
  </div>
</div>
<br/>
        <!-- <a href="view_hygienist_records.php" class="btn btn-info">Back to List</a>
        <a href="edit.php?id=<?php echo $result['Hygienist_Id'] ?>" class="btn btn-warning">Edit</a>
