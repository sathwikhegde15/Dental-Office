...
?>
    <h1 class="text-center">Add New Hygienist </h1>

    <form method="post" action="add_hygienist_success.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input required type="Emailid" class="form-control" id="Emailid"  name="Emailid" aria-describedby="EmailidHelp" >
