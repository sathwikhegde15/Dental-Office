<?php 
    class crud{
        ...
        public function getDentists(){
            try{
                $sql = "SELECT * FROM `dentist` d JOIN USER u ON
                d.User_Id = u.User_Id
            JOIN Role r ON
                r.Role_Id = u.Role_Id;";
                $result = $this->db->query($sql);
        ...
        public function getDentistDetails($id){
            try{
        ...
        public function deleteDentist($id){
            try{
                $this->deleteUser($id);
                 $sql = "delete from dentist where User_Id  = :id";
                 $stmt = $this->db->prepare($sql);
                 $stmt->bindparam(':id', $id);
                 $stmt->execute();
                 return true;
        ...
        public function getPatients(){
            try{
                $sql = "SELECT * FROM `patient` d JOIN USER u ON
                d.User_Id = u.User_Id
            JOIN Role r ON
                r.Role_Id = u.Role_Id;";
                $result = $this->db->query($sql);
        ...
        public function getPatientDetails($id){
         ...
         public function getHygienists(){
            try{
                $sql = "SELECT * FROM `hygienist` d JOIN USER u ON
                d.User_Id = u.User_Id
            JOIN Role r ON
                r.Role_Id = u.Role_Id;";
                $result = $this->db->query($sql);
        ...
        public function getHygienistDetails($id){
            try{
                 $sql = "select * from hygienist
                 where Hygienist_Id = :id";
                 $stmt = $this->db->prepare($sql);
                 $stmt->bindparam(':id', $id);
                 $stmt->execute();
                 $result = $stmt->fetch();
         ...
         public function deleteHygienist($id){
            try{
                $this->deleteUser($id);
                 $sql = "delete from hygienist where User_Id  = :id";
                 $stmt = $this->db->prepare($sql);
                 $stmt->bindparam(':id', $id);
                 $stmt->execute();
                 return true;
